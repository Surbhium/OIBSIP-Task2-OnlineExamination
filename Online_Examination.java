...
public class Online_Examination {
	...
	public void login() {
		data.put("SURBHI", 2003);
		data.put("SURBHI", 1456);
	...
	public void exam_que() {
		...
		while (System.currentTimeMillis() < endtime) {
			...
			System.out.println("\n\nQ.1) Who is the first prime President of india ?");
			System.out.println("\n(1) Manmohan Singh" + "\t" + "(2) Lal Bahadur Sashri" + "\t" + "(3) Narendra Modi"
			...
			System.out.println("\n\nQ.2)______ is the Biggest planet in our solar system?");
			...
			System.out.println("\n\nQ.3)How Many States are their in INDIA?");
			System.out.println("1) 28" + "\t" + "(2) 34" + "\t" + "3)56" + "\t" + "4)90");
			System.out.println("Enter correct option");
			ans = sc.nextInt();
			System.out.println("Answer Locked...");
			if (ans == 1) {
			...
			System.out.println("\n\nQ.4)Who established the Constitution Of INDIA?");
